											...
											<TBODY>
												<TR>
													...
													<TD>
													   ...
													   <INPUT class=textbox style="WIDTH: 80px" maxLength=50 name="customer.cust_name" id="cust_name" value="${param['cust_name'] }">
													   <input type="button" value="选择客户" onclick="window.open('${pageContext.request.contextPath}/CustomerAction_list?select=true','','width=600px,height=300px')" />
													</TD>
										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR
													...
													<TD>
													    <s:property value="#linkMan.lkm_name" />
												    </TD>
													<TD>
													    <s:property value="#linkMan.lkm_gender" />
												   </TD>
													<TD>
													    <s:property value="#linkMan.lkm_phone" />
												   </TD>
													<TD>
													   <s:property value="#linkMan.lkm_mobile" />
												   </TD>
													<TD>
								...
								<TR>
									<TD><SPAN id=pagelink>
											<DIV
												...
												,每页显示
												<select name="pageSize" id="pageSize" onchange="changePageSize($('#pageSize option:selected').val())">												
												...
												条
												[<A href="javaScript:void(0)" onclick="changeCurrentPage(<s:property value='#pageBean.currentPage-1' />)">前一页</A>]
												<B><s:property value="#pageBean.currentPage" /></B>
												[<A href="javaScript:void(0)" onclick="changeCurrentPage(<s:property value='#pageBean.currentPage+1' />)">后一页</A>] 
												到
												<input type="text" size="3" id="page" name="page" value="<s:property value="#pageBean.currentPage" />" />
												页
												
												<input type="button" value="Go" onclick="changeCurrentPage($('#page').val())"/>
											</DIV>
									</SPAN></TD>
								</TR>
							</TBODY>
