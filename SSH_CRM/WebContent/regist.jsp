          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=2 border=0>
              ...
              <TR>
                ...
                <TD style="HEIGHT: 28px">
                    <SPAN id=RequiredFieldValidator4 style="FONT-WEIGHT: bold; VISIBILITY: hidden; COLOR: white">
                                                             请输入密码
                    </SPAN>
                </TD>
              </TR>
              <TR>
                ...
                <TD style="HEIGHT: 28px">
                   <INPUT id=txtcode style="WIDTH: 130px" name="user_name"></TD>
              ...
              <TR>
                ...
                <TD>
                  ...
                  type=image src="images/regist_button.png" name=btn style="cursor: pointer;" onclick="window.location.href='${pageContext.request.contextPath}/UserAction_regist'"> 
                </TD>
              </TR>
           </TBODY>
        </TABLE>
