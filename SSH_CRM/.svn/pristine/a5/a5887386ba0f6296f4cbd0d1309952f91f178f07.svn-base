...
<head>
<TITLE>
<s:property value="#linkMan==null?'添加':'修改'"/>联系人
</TITLE> 
...
<BODY>
	...
	<FORM id=form1 name=form1
		action="${pageContext.request.contextPath }/LinkManAction_addLinkMan"
		method=post>
	   <input type="hidden" name="lmk_id" value="<s:property value="#linkMan.lmk_id"/>"/>	
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<TR>
								...
								<input type="radio" value="2" name="lkm_gender" <s:property value="#linkMan.lkm_gender=='1'?'checked':''"/>>女
								</td>
							</TR>
							<TR>
								<td>联系人办公电话 ：</td>
