...
<script type="text/javascript">
	$(function() {
		//弹出层插件调用
		new PopupLayer({
			trigger : ".clickedElement",//触发点，点击谁就弹出谁的div
			popupBlk : "#showDiv",//弹出的是哪个DIV
	...
	function findOrderInfoByOid(oid){
		...
		$.post(
			...
			function(data){
				...
				//[{"pimage":"products/1/c_0036.jpg","shop_price":4399.0,"pname":"华硕（ASUS）X450J","subtotal":4399.0,"count":1},
				...
				//{"pimage":"products/1/c_0011.jpg","shop_price":1799.0,"pname":"vivo X5M","subtotal":1799.0,"count":1}]
							...
							<c:forEach items="${orderList}" var="order" varStatus="vs">
								...
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td align="center" style="HEIGHT: 22px"><input
										type="button" value="订单详情" class="clickedElement" onclick="findOrderInfoByOid('${order.oid}')" />
									</td>
	...
	<div id="showDiv" class="blk" style="display: none;">
		<div class="main">
			...
			<div id="loading" style="padding-top: 30px; text-align: center;">
				<img alt="" style="width:200px; height:200px" src="${pageContext.request.contextPath }/images/loading.gif">
			</div>
