...
<body>
	<form id="userAction_save_do" name="Form1"
		action="${pageContext.request.contextPath}/admin?method=updateCategoryName&cid=${category.cid}"
		method="post">
		&nbsp;
		<table cellSpacing="1" cellPadding="5" width="100%" align="center"
			...
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff" colspan="3"><input
					type="text" name="cname" value="${category.cname}" id="userAction_save_do_logonName" class="bg" /></td>
			</tr>
