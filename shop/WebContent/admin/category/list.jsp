...
<script type="text/javascript">
	...
	function delCategory(cid){
		//确定是否要删除还条数据
		var isDel = confirm("您真的要删除这个吗？");
		if (isDel) {
			//确定删除
			location.href = "${pageContext.request.contextPath }/admin?method=deleteCategoryByCid&cid="+cid;
		}
	}
						...
						<c:forEach items="${categoryList }" var="category" varStatus="vs">
							...
							<tr onmouseover="this.style.backgroundColor = 'white'"
								...
								<td align="center" style="HEIGHT: 22px">
								   <a href="${pageContext.request.contextPath }/admin?method=findCategoryNameByCid&cid=${category.cid}">
